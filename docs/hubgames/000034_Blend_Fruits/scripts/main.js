...
'use strict';
{
  ...
  class YandexGamesSDKHandler {
    ...
    async InitializeYSDK() {
      ...
      console.log('%c YandexGamesSDK for Construct 3 v2.12.1 ', 'background: #14151f; color: #fb923c');
