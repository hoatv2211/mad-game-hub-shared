...
var LongWall = function(x, y, z, width) {
    var height = 4;
    var thickness = 3.5;
    //console.log(Table.wallContactMaterial);
    ...
    this.body.addShape(trimeshShape2, new CANNON.Vec3(width + 1.8, 0, 0));

    var boxshape = new CANNON.Box(new CANNON.Vec3(width - 0.1, height, thickness));
