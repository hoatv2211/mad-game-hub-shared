!(function(window) {
    if (!window.aft_path_prefix) {
        var path = window.location.pathname;
        path = path.split('/').filter(function(p) {
            return p != '' && p != 'index.html' && p != 'index.htm';
        }).join('/');

        window.aft_path_prefix = window.location.origin + "/" + path + '/';
    }
...
! function i(s, a, c) {
    ...
    57: [function(e, t, n) {
        ...
        t.exports = function(e, t, n, r, o, i, s) {
            ...
            if (b && (l = k(b.call(new e))) !== Object.prototype && l.next && (S(l, d, !0),
    ...
    122: [function(e, t, n) {
        ...
        if (e("./_descriptors")) {
            var m = e("./_library"),
                ...
                De = function(e, t) {
                    for (var n = 0, r = t.length, o = Ie(e, r); n < r;)
                        o[n] = t[n++];
                    return o
                },
                Ce = function(e, t, n) {
                ...
                Le = function e() {
                    for (var t = 0, n = arguments.length, r = Ie(this, n); t < n;)
                        r[t] = arguments[t++];
                    return r
                },
                Ne = !!V && v(function() {
                ...
                Be = {
                    ...
                    reverse: function e() {
                        for (var t, n = this, r = Pe(n).length, o = Math.floor(r / 2), i = 0; i < o;)
                            t = n[i],
                            n[i++] = n[--r],
                            n[r] = t;
                        return n
                ...
                Ve = function e(t, n, r) {
                    return !(qe(t, n = c(n, !0)) && k(r) && u(r, "value")) || u(r, "get") || u(r, "set") || r.configurable || u(r, "writable") && !r.writable || u(r, "enumerable") && !r.enumerable ? G(t, n, r) : (t[n] = r.value,
                        t)
                };
            xe || (U.f = ze,
                    B.f = Ve),
                ...
                t.exports = function(e, d, t, o) {
                    ...
                    a ? (h = t(function(e, t, n, r) {
                            ...
                            var o, i, s, a, c = 0,
                                u = 0;
                            if (k(t)) {
                                if (!(t instanceof X || (a = S(t)) == H || a == W))
                                    return Ee in t ? De(h, t) : Me.call(h, t);
                                o = t,
                                    u = Re(n, d);
                                var l = t.byteLength;
                                if (void 0 === r) {
                        ...
                        new h(null),
                            ...
                            var o;
                            return x(e, h, p),
                                k(t) ? t instanceof X || (o = S(t)) == H || o == W ? void 0 !== r ? new s(t, Re(n, d), r) : void 0 !== n ? new s(t, Re(n, d)) : new s(t) : Ee in t ? De(h, t) : Me.call(h, t) : new s(A(t))
                        }),
    ...
    123: [function(e, t, n) {
        ...
        if (s.ABV) {
            ...
            Z.setInt8(0, 2147483648),
                Z.setInt8(1, 2147483649), !Z.getInt8(0) && Z.getInt8(1) || c(E[y], {
        ...
        e("./_fix-re-wks")("replace", 2, function(i, s, w, x) {
            return [function e(t, n) {
                ...
                for (var l, d = "", f = 0, p = 0; p < c.length; p++) {
                    u = c[p];
                    for (var h = String(u[0]), _ = R(P(S(u.index), o.length), 0), g = [], m = 1; m < u.length; m++)
        ...
        e("./_fix-re-wks")("split", 2, function(i, s, g, m) {
            ...
            return b = "c" == "abbc" [o](/(b)*/)[1] || 4 != "test" [o](/(?:)/, -1)[h] || 2 != "ab" [o](/(?:ab)*/)[h] || 4 != "." [o](/(.?)(.?)/)[h] || 1 < "." [o](/()()/)[h] || "" [o](/.?/)[h] ? function(e, t) {
                    ...
                    for (var r, o, i, s = [], a = (e.ignoreCase ? "i" : "") + (e.multiline ? "m" : "") + (e.unicode ? "u" : "") + (e.sticky ? "y" : ""), c = 0, u = void 0 === t ? A : t >>> 0, l = new RegExp(e.source, a + "g");
                        (r = f.call(l, n)) && !(c < (o = l[_]) && (s.push(n.slice(c, r.index)),
                ...
                g, [function e(t, n) {
                    ...
                    for (var l = 0, d = 0, f = []; d < o.length;) {
                        ...
                        if (null === h || (p = j(x(c.lastIndex + (S ? 0 : d)), o.length)) === l)
                            d = w(o, d, s);
                        else {
    ...
    257: [function(e, t, n) {
        ...
        function r(e, t) {
            j(e);
            for (var n, r = x(t = k(t)), o = 0, i = r.length; o < i;)
                te(e, n = r[o++], t[n]);
            return e
        }
        ...
        function s(e, t) {
            if (e = k(e),
                ...
                e !== Q || !l(W, t) || l(Y, t)) {
                var n = L(e, t);
                return !n || !l(W, t) || l(e, q) && e[q][t] || (n.enumerable = !0),
                    n
            }
        }

        function a(e) {
            for (var t, n = F(k(e)), r = [], o = 0; n.length > o;)
                l(W, t = n[o++]) || t == q || t == h || r.push(t);
            return r
        }

        function c(e) {
            for (var t, n = e === Q, r = F(n ? Y : k(e)), o = [], i = 0; r.length > i;)
                !l(W, t = r[i++]) || n && !l(Q, t) || o.push(W[t]);
            return o
        }
        var u = e("./_global"),
            l = e("./_has"),
            ...
            te = function e(t, n, r) {
                return t === Q && te(Y, n, r),
                    ...
                    n = T(n, !0),
                    j(r),
                    l(W, n) ? (r.enumerable ? (l(t, q) && t[q][n] && (t[q][n] = !1),
                            r = P(r, {
                                enumerable: R(0, !1)
                            })) : (l(t, q) || N(t, q, R(1, {})),
                            t[q][n] = !0),
        ...
        f(f.S + f.F * se, "Object", {
            ...
            B[K][z] || e("./_hide")(B[K], z, B[K].valueOf),
            m(B, "Symbol"),
            m(Math, "Math", !0),
            m(u.JSON, "JSON", !0)
    }, {
                        ...
                        this._instanceConstructor = e,
                            ...
                            n(t) ? (this.length = t.length,
                                ...
                                0 === this.length ? A(this.promise, this._result) : (this.length = this.length || 0,
                                    this._enumerate(t),
                                    0 === this._remaining && A(this.promise, this._result))) : S(this.promise, function e() {
    ...
    333: [function(require, module, exports) {
        (function(global) {
            var uoa, voa;
            uoa = "undefined" != typeof self ? self : "undefined" != typeof window ? window : void 0 !== global ? global : this,
                voa = function(global) {
                    "use strict";
                    global = global || {};
        ...
        ! function(e) {
            ...
            function y(e, t) {
                ...
                if (e instanceof y) {
                    ...
                    this.url = String(e);
                if (this.credentials = t.credentials || this.credentials || "omit", !t.headers && this.headers || (this.headers = new h(t.headers)),
        ...
        var r = function() {
            ...
            return function e(t, n, r) {
                    ...
                    value: function e(t, n) {
                        ...
                        o = encodeURIComponent(i.Base64.encode(JSON.stringify([o]))),
                            fetch(this._url + "?tp=com.gdsdk.".concat(t, "&ar=").concat(o, "&ts=").concat(Date.now()))
                    }
                }, {
                    key: "setGameData",
                    value: function e(t) {
                ...
                t = function() {
                    function s(e, t) {
                        ...
                        (g = this).options = t ? (0,
                            ...
                            (0,
                                h.getParentDomain)().includes("girlsgogames.") && (this.userAllowedPersonalizedAds = !1),
                    ...
                    return function e(t, n, r) {
                                            ...
                                            switch (t.prev = t.next) {
                                                case 0:
                                                    return t.prev = 0,
                                                        ...
                                                        o = (0,
                                                            h.getScript)(r, "gdsdk_prebid", {
                                                            alternates: n
                                                        }),
                                                        window.idhbgd = window.idhbgd || {},
                                                        window.idhbgd.que = window.idhbgd.que || [],
                                                        i = null,
                                                        s = this.options.debug ? i[0] : i[1],
                                                        t.next = 10,
                                                        (0,
                                                            h.getScript)(s, "gdsdk_ima", null);
                                                case 10:
                                                    return a = t.sent,
                                                        this._createPlayer(),
                                                        this._setUpIMA(),
                            ...
                            value: function e(t) {
                                ...
                                return new Promise(function(s) {
                                    if (localStorage.getItem("gd_debug") && localStorage.getItem("gd_tag"))
                                        s(localStorage.getItem("gd_tag"));
                                    else
                                        try {
                                            1 === a.adTypeCount && (a.adCount = 0),
                                                a.adCount++,
                                                a.adTypeCount++,
                                                a._tunnlReportingKeys(t).then(function(e) {
                                                    var t = e.data;
                            ...
                            value: function e(d) {
                                ...
                                return new Promise(function(n) {
                                    ...
                                    var t = (0,
                                        ...
                                        o = (0,
                                            h.getQueryString)("ch", window.location.href),
                                        i = (0,
                                            h.getQueryString)("ch_date", window.location.href),
                                        s = o ? "&ch=".concat(o) : "",
                                        a = i ? "&ch_date=".concat(i) : "",
                                        c = d === p.AdType.Rewarded ? 1 : 0,
                                        u = "".concat(e, "&player_width=").concat(f.options.width, "&player_height=").concat(f.options.height, "&ad_type=video_image&os=").concat(t, "&game_id=").concat(f.gameId, "&ad_position=").concat(r).concat(s).concat(a, "&rewarded=").concat(c, "&correlator=").concat(Date.now()),
                                        l = new Request(u, {
                                            method: "GET"
                                        });
                                ...
                                return o = o || {},
                                    new Promise(function(e) {
                                        ...
                                        try {
                                            ...
                                            t.adTagUrl = r,
                                                t.linearAdSlotWidth = i.options.width,
                                                t.linearAdSlotHeight = i.options.height,
                                                t.nonLinearAdSlotWidth = i.options.width,
                                                t.nonLinearAdSlotHeight = i.options.height,
                                                t.forceNonLinearFullSlot = !0;
                                            var n = {
                                                adType: o.adType,
                                                initialAd: o.initialAd
                                            };
                                            i.adsLoader.requestAds(t, n),
                                                e(t)
                                        } catch (e) {
                                            throw new Error(e)
                                        }
                            ...
                            value: (u = f(regeneratorRuntime.mark(function e(n) {
                                    ...
                                    return regeneratorRuntime.wrap(function e(t) {
                                        for (;;)
                                            switch (t.prev = t.next) {
                                                case 0:
                                                    if (n === p.AdType.Interstitial)
                                                        return t.abrupt("return", this._startInterstitialAd());
                                                    t.next = 4;
                                                    break;
                                                case 4:
                                                    if (n === p.AdType.Rewarded)
                                                        return t.abrupt("return", this._startRewardedAd());
                                                    t.next = 8;
                                                    break;
                                                case 8:
                                        ...
                                        for (;;)
                                            switch (t.prev = t.next) {
                                                case 0:
                                                    ...
                                                    return t.next = 7,
                                                        this._requestAd(p.AdType.Interstitial);
                                                case 7:
                                                    t.t0 = t.sent;
                                                case 8:
                                                    return n = t.t0,
                                                ...
                                                case 12:
                                                    return r = t.sent,
                                                        t.next = 15,
                                                        Promise.all([n, r, new Promise(function(e, t) {
                                                            var n = "videoad.preloadad";
                                                            o.eventBus.unsubscribeScope(n),
                                                                o.eventBus.subscribe("AD_SDK_MANAGER_READY", function() {
                                                                    return e()
                                                                }, n),
                                                                o.eventBus.subscribe("AD_SDK_CANCEL", function() {
                                                                    return e()
                                                                }, n),
                                                                o.eventBus.subscribe("AD_ERROR", function() {
                                        ...
                                        for (;;)
                                            switch (t.prev = t.next) {
                                                case 0:
                                                    ...
                                                    return t.next = 7,
                                                        this._requestAd(p.AdType.Rewarded);
                                                case 7:
                                                    t.t0 = t.sent;
                                                case 8:
                                                    return n = t.t0,
                            ...
                            value: function e() {
                                ...
                                r.id = "".concat(this.prefix, "advertisement_slot"),
                                    ...
                                    this.thirdPartyContainer ? (this.adContainer.appendChild(r),
                                        this.thirdPartyContainer.appendChild(this.adContainer)) : (this.adContainer.appendChild(r),
                            ...
                            value: function e() {
                                ...
                                google.ima.settings.setVpaidMode(google.ima.ImaSdkSettings.VpaidMode.ENABLED),
                                    ...
                                    this.adDisplayContainer = new google.ima.AdDisplayContainer(document.getElementById("".concat(this.prefix, "advertisement_slot"))),
                            ...
                            value: function e(t) {
                                ...
                                r.enablePreloading = !0,
                                    ...
                                    this.adsManager = t.getAdsManager(r),
                            ...
                            value: function e(t) {
                                var n = new Date,
                                    ...
                                    s = n.getFullYear(),
                                    a = (0,
                                        h.getKeyByValue)(google.ima.AdEvent.Type, t.type),
                                    c = "";
                                switch (t.type) {
            ...
            var b = null,
                n = function() {
                    function s(e) {
                        ...
                        var o = (0,
                            l.getQueryParams)("xanthophyll");
                        o.hasOwnProperty("xanthophyll") && "true" === o.xanthophyll && (this.whitelabelPartner = !0,
                            (0,
                                g.dankLog)("White label publisher", "".concat(this.whitelabelPartner), "success"));
                        ...
                        this.msgrt = new c.default({
                            ...
                            this._subscribeToEvents(this.options.gameId, h),
                            this._gdpr(h),
                            this.adRequestTimer = void 0,
                            this.lastRequestedAdType = void 0,
                                            ...
                                            switch (t.prev = t.next) {
                                                case 0:
                                                    return t.prev = 0,
                                                        ...
                                                        t.next = 4,
                                                        d._getGameData(d.options.gameId, h);
                                                case 4:
                                                    return s = t.sent,
                                                        localStorage.getItem("gd_debug") && localStorage.getItem("gd_midroll") && (s.midroll = parseInt(localStorage.getItem("gd_midroll"))),
                                                        // d.options.testing = d.options.testing || s.diagnostic && !0 === s.diagnostic.testing,
                                                        // d.options.testing && (0,
                                                        // g.dankLog)("Testing enabled", d.options.testing, "info"),
                                                        //a = s.gdpr && !0 === s.gdpr.consent,
                                                        true ? (d.options.advertisementSettings.autoplay || a) && d._createSplash(s, a) : d.adRequestTimer = new Date,
                                                        d.adInstance = new _.default(d.options.flashSettings.adContainerId, d.options.advertisementSettings),
                                                        d.adInstance.parentURL = p,
                                                        d.adInstance.parentDomain = h,
                                                        d.adInstance.gameId = "",
                                                        d.adInstance.category = "",
                                                        d.adInstance.tags = "",
                                                        t.next = 18,
                                                        d.adInstance.start();
                                                case 18:
                                                    c = "SDK_READY",
                                                        u = "Everything is ready.",
                                                        d.eventBus.broadcast(c, {
                                                            name: c,
                                                            message: u,
                                                            status: "success",
                                                            analytics: {
                    ...
                    return function e(t, n, r) {
                            ...
                            value: function e(t, n) {
                                ...
                                this.eventBus = new o.default,
                                    u.SDKEvents.forEach(function(e) {
                                    ...
                                    this.eventBus.subscribe("AD_SDK_CANCELED", function() {
                                        r.onResumeGame("Advertisement error, no worries, start / resume the game.", "warning"),
                                            r.msgrt.send("ad.cancelled")
                                    }, "sdk"),
                                    u.IMAEvents.forEach(function(e) {
                                        return r.eventBus.subscribe(e, function(e) {
                                            return r._onEvent(e)
                                        }, "ima")
                                    }),
                            ...
                            value: function e(t) {
                                (0,
                                    g.dankLog)(t.name, t.message, t.status),
                            ...
                            value: function e(o, i) {
                                ...
                                return new Promise(function(n) {
                                    var r = {
                                        ...
                                        e = window.aft_path_prefix + "data/get".concat("?domain=").concat(i, "&localTime=").concat((new Date).getHours(), "&v=").concat(a.default.version),
                                        t = new Request(e, {
                                            method: "GET"
                                        });
                                    fetch(t).then(function(e) {
                                        ...
                                        if (e.success) {
                                            var t = {
                                                ...
                                                push_cuda: (0,
                                                    l.parseJSON)(e.result.game.push_cuda),
                                                bloc_gard: (0,
                                                    l.parseJSON)(e.result.game.bloc_gard),
                                                ctry: e.result.game.ctry,
                                                cookie: (0,
                                                    l.parseJSON)(e.result.game.cookie),
                                                sdk: (0,
                                                    l.parseJSON)(e.result.game.sdk),
                                                gdpr: (0,
                                                    l.parseJSON)(e.result.game.gdpr),
                                                diagnostic: (0,
                                                    l.parseJSON)(e.result.game.diagnostic)
                                            };
                                            r = (0,
                                                    l.extendDefaults)(r, t),
                                                s.msgrt.setGameData(r),
                                                (0,
                                                    g.setDankLog)(r.diagnostic),
                                                r.bloc_gard && !0 === r.bloc_gard.enabled ? (s.msgrt.send("blocked"),
                                                    setTimeout(function() {
                            ...
                            value: function e(t, n) {
                                ...
                                o = o ? "/".concat(o.name) : t.assets[0].hasOwnProperty("name") ? "/".concat(t.assets[0].name) : "/logo.svg";
                                                                    ...
                                                                    switch (t.prev = t.next) {
                                                                        case 0:
                                                                            return t.prev = 0,
                                                                                ...
                                                                                u.readyPromise;
                                                                        case 3:
                                                                            if ((o = t.sent).bloc_gard && !0 === o.bloc_gard.enabled)
                                                                                throw new Error("Game or domain is blocked.");
                                                                            t.next = 6;
                                                                            break;
                                                                        case 6:
                                                                            if (!o.advertisements || u.whitelabelPartner)
                                                                        ...
                                                                        case 16:
                                                                            ...
                                                                            break;
                                                                        case 20:
                                                                            return u.lastRequestedAdType = c,
                                                                                i = "main.showad",
                                            ...
                                            switch (t.prev = t.next) {
                                                case 0:
                                                    return t.prev = 0,
                                                        ...
                                                        this.readyPromise;
                                                case 3:
                                                    if ((n = t.sent).bloc_gard && !0 === n.bloc_gard.enabled)
                                                        throw new Error("Game or domain is blocked.");
                                                    t.next = 6;
                                                    break;
                                                case 6:
                            ...
                            value: function e() {
                                try {
                                    new i.default(this.options.testing).start(),
        ...
        Object.defineProperty(n, "__esModule", {
            ...
            n.getParentUrl = function e() {
                ...
                if (-1 !== document.referrer.indexOf("gameplayer.io")) {
                    ...
                    -1 !== document.referrer.indexOf("localhost") && (n = "/");
                return n
            },
            n.getParentDomain = function e() {
                ...
                if (-1 !== document.referrer.indexOf("gameplayer.io")) {
                    ...
                    -1 !== document.referrer.indexOf("localhost") && (n = "www.afantai.com");
                return n
            },
            n.getQueryParams = s,
