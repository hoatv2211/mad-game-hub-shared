! function (e) {
    ...
    l = function () {
      ...
      return e.getInstance = function () {
        if (!this.instance) try {
          var e = window.parent;
          window.location.origin.endsWith("yandex.net") ? (f("Running with YandexSDK"), this.instance = new c.default) : e.Crazygames && e.Crazygames.load ? (f("Running with CrazySDK"), this.instance = new u.default) : (f("Running with LocalSDK"), i = !0, this.instance = new s.default)
        } catch (e) {
  ...
  var d = [{
    ...
    h = function () {
      function e() {
        this.initState = s.UNINITIALIZED, this.requestInProgress = !1, this.eventListeners = {}, this.adblockDetectionExecuted = !1, this.hasAdblock = !1, this.gameLink = null
      }
      return e.prototype.addEventListener = function (e, t) {
        ...
        if (i) {
          ...
          o.setAttribute("src", "" + e.size + ".png"), o.setAttribute("width", n + "px"), o.setAttribute("height", r + "px"), i.appendChild(o), i.style.backgroundColor = "rgb(191, 173, 255, 0.25)"
        }
      }, e
    }();
  t.default = h
  ...
  t.requestInGameBanner = function (e) {
    ...
    return window.CrazygamesAds ? Promise.resolve() : function (e) {
      ...
      return o = u(e).then((function () {
        var e = window;
        e.CrazygamesAds.initAds && e.CrazygamesAds.initAds()
      }))
    }(e)
  }
}, function (e, t, n) {
  ...
  var l = u(n(1)),
    ...
    h = function (e) {
      function t() {
        ...
        return t.queuedBanners = [], t.initCallbacks = [], t.rafvertizingUrl = "", t.receiveMessage = function (e) {
          var n = e.data,
            r = n.type,
            i = n.data;
      ...
      return i(t, e), t.prototype.init = function () {
        ...
        })), this.addEventListener("bannerRendered", (function (e) {
          d.debug("Banner rendered for container " + e.containerId)
      ...
      return i(this, (function (t) {
        return [2, new Promise((function (t) {
          var n = new IntersectionObserver((function (e) {
            var r = e[0];
            t({
              isVisible: r.intersectionRatio > .95,
              size: {
  ...
  t.checkContainerVisible = function (e, t, n) {
    return r(this, void 0, void 0, (function () {
      var r, a;
      return i(this, (function (i) {
        switch (i.label) {
          case 0:
            return (r = document.getElementById(e)) ? [4, o(r)] : (t("The container " + e + " is not present on the page"), [2, {
              isVisible: !1,
              size: {
                width: 0,
                height: 0
          ...
          case 1:
            return (a = i.sent()).isVisible ? !n || 0 !== a.size.width && 0 !== a.size.height ? (r.classList.add("crazy-banner-container"), [2, a]) : (t("The container " + e + " must have a non-null width and height to render a responsive banner."), [2, {
              isVisible: !1,
              size: {
                width: 0,
                height: 0
              }
            }]) : (t("The container " + e + " is not entirely visible on the page"), [2, a])
        }
      }))
    }))
  }
  ...
  (function (t) {
    ...
    var A, O, C, z = Function.prototype,
      D = Object.prototype,
      L = S["__core-js_shared__"],
      P = (A = /[^.]+$/.exec(L && L.keys && L.keys.IE_PROTO || "")) ? "Symbol(src)_1." + A : "",
      q = z.toString,
      M = D.hasOwnProperty,
      R = D.toString,
      B = RegExp("^" + q.call(M).replace(/[\\^$.*+?()[\]{}|]/g, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"),
      N = S.Symbol,
      F = N ? N.iterator : void 0,
      V = D.propertyIsEnumerable,
      K = Math.floor,
      U = (O = Object.keys, C = Object, function (e) {
        return O(C(e))
      }),
      G = Math.random,
      Z = ae(S, "DataView"),
    ...
    function ne(e, t) {
      var n = fe(e) || function (e) {
          return function (e) {
            return ye(e) && de(e)
          }(e) && M.call(e, "callee") && (!V.call(e, "callee") || "[object Arguments]" == R.call(e))
        }(e) ? function (e, t) {
        ...
        r = n.length,
        i = !!r;
      for (var o in e) !t && !M.call(e, o) || i && ("length" == o || se(o, r)) || n.push(o);
      return n
    }
    ...
    function ie(e) {
      if (n = (t = e) && t.constructor, r = "function" == typeof n && n.prototype || D, t !== r) return U(e);
      var t, n, r, i = [];
      for (var o in Object(e)) M.call(e, o) && "constructor" != o && i.push(o);
      return i
    }
    ...
    function le(e, t, u) {
      var c, l, f, d = -1,
        h = function (e) {
          ...
          if (de(e)) return function (e) {
            return "string" == typeof e || !fe(e) && ye(e) && "[object String]" == R.call(e)
          }(e) ? j(e) : function (e, t) {
            var n = -1,
              r = e.length;
      ...
      for ((u ? function (e, t, n) {
          ...
          var t = function (e) {
              return e ? (e = function (e) {
                ...
                if (function (e) {
                    return "symbol" == typeof e || ye(e) && "[object Symbol]" == R.call(e)
                  }(e)) return NaN;
                if (pe(e)) {
      ...
      return h.length = t, h
    }(Z && "[object DataView]" != ue(new Z(new ArrayBuffer(1))) || $ && ue(new $) != n || Y && "[object Promise]" != ue(Y.resolve()) || Q && ue(new Q) != r || W && "[object WeakMap]" != ue(new W)) && (ue = function (e) {
      var t = R.call(e),
  ...
  var l = u(n(1)),
    ...
    d = function (e) {
      ...
      return i(t, e), t.prototype.init = function () {
        ...
        var t = this;
        f.debug("requesting " + e + " ad"), 
        this.requestInProgress = !0, 
        // this.showOverlay(), 
        // this.overlay.innerHTML = "<h1>A " + e + " ad would appear xxxx</h1>", 
      ...
      return i(t, e), t.prototype.init = function () {
        ...
        return s(this, void 0, void 0, (function () {
          ...
          return c(this, (function (n) {
            switch (n.label) {
              case 0:
                return d.debug("Initializing"), this.initState = l.INIT_STATE.REQUESTED, [4, f.loadScript("")];
              case 1:
              ...
              case 1:
                return t.sent().adv.showFullscreenAdv({
                  callbacks: {
                    ...
                    onError: function () {
                      e.requestInProgress = !1, e.callListeners("adError", {})
                    }
                  }
                }), [2]
            }
